...
from colbert.indexing.faiss import index_faiss, index_flat_faiss
...
def main():
    ...
    parser.add_argument('--slices', dest='slices', default=1, type=int)     # slice index to m according to memory
