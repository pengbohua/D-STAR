...
class CollectionEncoder():
    def __init__(self, args, process_idx, num_processes):
        ...
        self._load_model()
        print("Initializing index manager, index dim and save_path")
        self.indexmgr = IndexManager(args.dim)
        print("Loading collection.tsv")
    ...
    def encode(self):
        ...
        # Each thread gets a batch from the processed data queue and dumps this batch to self._save_batch
        thread.start()
