...
class EagerBatcher():
    '''
    Train on triples with query, pos, neg written in the input tsv
    '''
    def __init__(self, args, rank=0, nranks=1):
        ...
        self.tensorize_triples = partial(tensorize_triples, self.query_tokenizer, self.doc_tokenizer)   # tensorize_triples fixed q_tokenizer d_tokenizer arguments
